      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
          ...
          <div v-if="listing.image_path" class="aspect-video bg-gray-100 dark:bg-gray-700">
            <img :src="`/storage/${listing.image_path}`" :alt="listing.title" class="w-full h-full object-cover" />
          </div>
        ...
        <div v-if="relatedListings && relatedListings.length > 0" class="mt-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link v-for="related in relatedListings" :key="related.id" :href="`/listings/${related.id}`"
            ...
            <div class="aspect-video bg-gray-100 dark:bg-gray-700">
              <img v-if="related.image_path" :src="`/storage/${related.image_path}`" :alt="related.title"
